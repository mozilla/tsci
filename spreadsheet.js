...
async function moveSheet(sheets, spreadsheetId, dateOrTitle, index) {
  ...
  const title =
    dateOrTitle === "Summary" ? dateOrTitle : getSheetTitle(dateOrTitle);
...
async function addBugData(sheets, spreadsheetId, bugTable, title) {
  ...
  console.log(
    "Updated duplicates (Desktop) cells: " + result.data.updatedCells
  );
}
...
async function addStaticData(
  ...
  console.log(
    "Updated weighted SCI (mobile) cells: " + result.data.updatedCells
  );
  ...
  console.log(
    "Updated weighted SCI (desktop) cells: " + result.data.updatedCells
  );
