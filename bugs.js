...
const getBugzilla = async (website, bugzillaKey, minDate, maxDate = new Date(), includeFenix) => {
    ...
    const openMobileQuery = `https://bugzilla.mozilla.org/buglist.cgi?query_format=advanced&f1=OP${helpers.getBugzillaPriorities()}${helpers.getBugURL(website)}&f2=creation_ts&o2=greaterthaneq&v2=${minDateQuery}&resolution=---${helpers.getBugzillaStatuses()}${maxDateQueryFragment(3)}${searchConstraintQueryFragment}&j4=OR&f4=OP&f5=product&o5=equals&v5=Core${FenixQueryPart}&f7=product&o7=equals&v7=Firefox%20for%20Android&f9=OP&f10=product&o10=equals&v10=Web%20Compatibility&f11=component&o11=equals&v11=Mobile&f12=CP&op_sys=Unspecified&op_sys=All&op_sys=Android${notSeeAlsoQueryFragment(13)}`;
